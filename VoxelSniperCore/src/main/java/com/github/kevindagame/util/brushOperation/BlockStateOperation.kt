...
class BlockStateOperation(location: BaseLocation, val oldState: IBlockState, var newState: IBlockState) : BrushOperation(location) {
    ...
    constructor(location: BaseLocation, oldState: IBlockState, newState: IBlockState, force: Boolean, applyPhysics: Boolean) : this(
