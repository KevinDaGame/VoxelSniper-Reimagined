...
public class VoxelMaterial implements IMaterial {
    ...
    public static final VoxelMaterial OAK_SAPLING = register("minecraft", "oak_sapling");
    public static final VoxelMaterial SPRUCE_SAPLING = register("minecraft", "spruce_sapling");
    public static final VoxelMaterial BIRCH_SAPLING = register("minecraft", "birch_sapling");
    public static final VoxelMaterial JUNGLE_SAPLING = register("minecraft", "jungle_sapling");
    public static final VoxelMaterial ACACIA_SAPLING = register("minecraft", "acacia_sapling");
    public static final VoxelMaterial DARK_OAK_SAPLING = register("minecraft", "dark_oak_sapling");
    ...
    public static final VoxelMaterial WHITE_BED = register("minecraft", "white_bed");
    public static final VoxelMaterial ORANGE_BED = register("minecraft", "orange_bed");
    public static final VoxelMaterial MAGENTA_BED = register("minecraft", "magenta_bed");
    public static final VoxelMaterial LIGHT_BLUE_BED = register("minecraft", "light_blue_bed");
    public static final VoxelMaterial YELLOW_BED = register("minecraft", "yellow_bed");
    public static final VoxelMaterial LIME_BED = register("minecraft", "lime_bed");
    public static final VoxelMaterial PINK_BED = register("minecraft", "pink_bed");
    public static final VoxelMaterial GRAY_BED = register("minecraft", "gray_bed");
    public static final VoxelMaterial LIGHT_GRAY_BED = register("minecraft", "light_gray_bed");
    public static final VoxelMaterial CYAN_BED = register("minecraft", "cyan_bed");
    public static final VoxelMaterial PURPLE_BED = register("minecraft", "purple_bed");
    public static final VoxelMaterial BLUE_BED = register("minecraft", "blue_bed");
    public static final VoxelMaterial BROWN_BED = register("minecraft", "brown_bed");
    public static final VoxelMaterial GREEN_BED = register("minecraft", "green_bed");
    public static final VoxelMaterial RED_BED = register("minecraft", "red_bed");
    public static final VoxelMaterial BLACK_BED = register("minecraft", "black_bed");
    public static final VoxelMaterial POWERED_RAIL = register("minecraft", "powered_rail");
    public static final VoxelMaterial DETECTOR_RAIL = register("minecraft", "detector_rail");
    ...
    public static final VoxelMaterial GRASS = register("minecraft", "grass");
    public static final VoxelMaterial FERN = register("minecraft", "fern");
    public static final VoxelMaterial DEAD_BUSH = register("minecraft", "dead_bush");
    public static final VoxelMaterial SEAGRASS = register("minecraft", "seagrass");
    public static final VoxelMaterial TALL_SEAGRASS = register("minecraft", "tall_seagrass");
    ...
    public static final VoxelMaterial DANDELION = register("minecraft", "dandelion");
    public static final VoxelMaterial POPPY = register("minecraft", "poppy");
    public static final VoxelMaterial BLUE_ORCHID = register("minecraft", "blue_orchid");
    public static final VoxelMaterial ALLIUM = register("minecraft", "allium");
    public static final VoxelMaterial AZURE_BLUET = register("minecraft", "azure_bluet");
    public static final VoxelMaterial RED_TULIP = register("minecraft", "red_tulip");
    public static final VoxelMaterial ORANGE_TULIP = register("minecraft", "orange_tulip");
    public static final VoxelMaterial WHITE_TULIP = register("minecraft", "white_tulip");
    public static final VoxelMaterial PINK_TULIP = register("minecraft", "pink_tulip");
    public static final VoxelMaterial OXEYE_DAISY = register("minecraft", "oxeye_daisy");
    public static final VoxelMaterial CORNFLOWER = register("minecraft", "cornflower");
    public static final VoxelMaterial WITHER_ROSE = register("minecraft", "wither_rose");
    public static final VoxelMaterial LILY_OF_THE_VALLEY = register("minecraft", "lily_of_the_valley");
    public static final VoxelMaterial BROWN_MUSHROOM = register("minecraft", "brown_mushroom");
    public static final VoxelMaterial RED_MUSHROOM = register("minecraft", "red_mushroom");
    ...
    public static final VoxelMaterial TORCH = register("minecraft", "torch");
    public static final VoxelMaterial WALL_TORCH = register("minecraft", "wall_torch");
    public static final VoxelMaterial FIRE = register("minecraft", "fire");
    public static final VoxelMaterial SOUL_FIRE = register("minecraft", "soul_fire");
    ...
    public static final VoxelMaterial REDSTONE_WIRE = register("minecraft", "redstone_wire");
    ...
    public static final VoxelMaterial WHEAT = register("minecraft", "wheat");
    ...
    public static final VoxelMaterial OAK_SIGN = register("minecraft", "oak_sign");
    public static final VoxelMaterial SPRUCE_SIGN = register("minecraft", "spruce_sign");
    public static final VoxelMaterial BIRCH_SIGN = register("minecraft", "birch_sign");
    public static final VoxelMaterial ACACIA_SIGN = register("minecraft", "acacia_sign");
    public static final VoxelMaterial JUNGLE_SIGN = register("minecraft", "jungle_sign");
    public static final VoxelMaterial DARK_OAK_SIGN = register("minecraft", "dark_oak_sign");
    public static final VoxelMaterial OAK_DOOR = register("minecraft", "oak_door");
    public static final VoxelMaterial LADDER = register("minecraft", "ladder");
    public static final VoxelMaterial RAIL = register("minecraft", "rail");
    public static final VoxelMaterial COBBLESTONE_STAIRS = register("minecraft", "cobblestone_stairs");
    public static final VoxelMaterial OAK_WALL_SIGN = register("minecraft", "oak_wall_sign");
    public static final VoxelMaterial SPRUCE_WALL_SIGN = register("minecraft", "spruce_wall_sign");
    public static final VoxelMaterial BIRCH_WALL_SIGN = register("minecraft", "birch_wall_sign");
    public static final VoxelMaterial ACACIA_WALL_SIGN = register("minecraft", "acacia_wall_sign");
    public static final VoxelMaterial JUNGLE_WALL_SIGN = register("minecraft", "jungle_wall_sign");
    public static final VoxelMaterial DARK_OAK_WALL_SIGN = register("minecraft", "dark_oak_wall_sign");
    public static final VoxelMaterial LEVER = register("minecraft", "lever");
    public static final VoxelMaterial STONE_PRESSURE_PLATE = register("minecraft", "stone_pressure_plate");
    public static final VoxelMaterial IRON_DOOR = register("minecraft", "iron_door");
    public static final VoxelMaterial OAK_PRESSURE_PLATE = register("minecraft", "oak_pressure_plate");
    public static final VoxelMaterial SPRUCE_PRESSURE_PLATE = register("minecraft", "spruce_pressure_plate");
    public static final VoxelMaterial BIRCH_PRESSURE_PLATE = register("minecraft", "birch_pressure_plate");
    public static final VoxelMaterial JUNGLE_PRESSURE_PLATE = register("minecraft", "jungle_pressure_plate");
    public static final VoxelMaterial ACACIA_PRESSURE_PLATE = register("minecraft", "acacia_pressure_plate");
    public static final VoxelMaterial DARK_OAK_PRESSURE_PLATE = register("minecraft", "dark_oak_pressure_plate");
    public static final VoxelMaterial REDSTONE_ORE = register("minecraft", "redstone_ore");
    public static final VoxelMaterial DEEPSLATE_REDSTONE_ORE = register("minecraft", "deepslate_redstone_ore", V1_17);
    public static final VoxelMaterial REDSTONE_TORCH = register("minecraft", "redstone_torch");
    public static final VoxelMaterial REDSTONE_WALL_TORCH = register("minecraft", "redstone_wall_torch");
    public static final VoxelMaterial STONE_BUTTON = register("minecraft", "stone_button");
    public static final VoxelMaterial SNOW = register("minecraft", "snow");
    ...
    public static final VoxelMaterial CACTUS = register("minecraft", "cactus");
    public static final VoxelMaterial CLAY = register("minecraft", "clay");
    public static final VoxelMaterial SUGAR_CANE = register("minecraft", "sugar_cane");
    ...
    public static final VoxelMaterial SOUL_TORCH = register("minecraft", "soul_torch");
    public static final VoxelMaterial SOUL_WALL_TORCH = register("minecraft", "soul_wall_torch");
    ...
    public static final VoxelMaterial CAKE = register("minecraft", "cake");
    public static final VoxelMaterial REPEATER = register("minecraft", "repeater");
    ...
    public static final VoxelMaterial ATTACHED_PUMPKIN_STEM = register("minecraft", "attached_pumpkin_stem");
    public static final VoxelMaterial ATTACHED_MELON_STEM = register("minecraft", "attached_melon_stem");
    public static final VoxelMaterial PUMPKIN_STEM = register("minecraft", "pumpkin_stem");
    public static final VoxelMaterial MELON_STEM = register("minecraft", "melon_stem");
    public static final VoxelMaterial VINE = register("minecraft", "vine");
    public static final VoxelMaterial GLOW_LICHEN = register("minecraft", "glow_lichen", V1_17);
    ...
    public static final VoxelMaterial LILY_PAD = register("minecraft", "lily_pad");
    ...
    public static final VoxelMaterial NETHER_WART = register("minecraft", "nether_wart");
    ...
    public static final VoxelMaterial COCOA = register("minecraft", "cocoa");
    ...
    public static final VoxelMaterial TRIPWIRE_HOOK = register("minecraft", "tripwire_hook");
    ...
    public static final VoxelMaterial CARROTS = register("minecraft", "carrots");
    public static final VoxelMaterial POTATOES = register("minecraft", "potatoes");
    public static final VoxelMaterial OAK_BUTTON = register("minecraft", "oak_button");
    public static final VoxelMaterial SPRUCE_BUTTON = register("minecraft", "spruce_button");
    public static final VoxelMaterial BIRCH_BUTTON = register("minecraft", "birch_button");
    public static final VoxelMaterial JUNGLE_BUTTON = register("minecraft", "jungle_button");
    public static final VoxelMaterial ACACIA_BUTTON = register("minecraft", "acacia_button");
    public static final VoxelMaterial DARK_OAK_BUTTON = register("minecraft", "dark_oak_button");
    ...
    public static final VoxelMaterial LIGHT_WEIGHTED_PRESSURE_PLATE = register("minecraft", "light_weighted_pressure_plate");
    public static final VoxelMaterial HEAVY_WEIGHTED_PRESSURE_PLATE = register("minecraft", "heavy_weighted_pressure_plate");
    public static final VoxelMaterial COMPARATOR = register("minecraft", "comparator");
    ...
    public static final VoxelMaterial ACTIVATOR_RAIL = register("minecraft", "activator_rail");
    ...
    public static final VoxelMaterial WHITE_CARPET = register("minecraft", "white_carpet");
    public static final VoxelMaterial ORANGE_CARPET = register("minecraft", "orange_carpet");
    public static final VoxelMaterial MAGENTA_CARPET = register("minecraft", "magenta_carpet");
    public static final VoxelMaterial LIGHT_BLUE_CARPET = register("minecraft", "light_blue_carpet");
    public static final VoxelMaterial YELLOW_CARPET = register("minecraft", "yellow_carpet");
    public static final VoxelMaterial LIME_CARPET = register("minecraft", "lime_carpet");
    public static final VoxelMaterial PINK_CARPET = register("minecraft", "pink_carpet");
    public static final VoxelMaterial GRAY_CARPET = register("minecraft", "gray_carpet");
    public static final VoxelMaterial LIGHT_GRAY_CARPET = register("minecraft", "light_gray_carpet");
    public static final VoxelMaterial CYAN_CARPET = register("minecraft", "cyan_carpet");
    public static final VoxelMaterial PURPLE_CARPET = register("minecraft", "purple_carpet");
    public static final VoxelMaterial BLUE_CARPET = register("minecraft", "blue_carpet");
    public static final VoxelMaterial BROWN_CARPET = register("minecraft", "brown_carpet");
    public static final VoxelMaterial GREEN_CARPET = register("minecraft", "green_carpet");
    public static final VoxelMaterial RED_CARPET = register("minecraft", "red_carpet");
    public static final VoxelMaterial BLACK_CARPET = register("minecraft", "black_carpet");
    ...
    public static final VoxelMaterial SUNFLOWER = register("minecraft", "sunflower");
    public static final VoxelMaterial LILAC = register("minecraft", "lilac");
    public static final VoxelMaterial ROSE_BUSH = register("minecraft", "rose_bush");
    public static final VoxelMaterial PEONY = register("minecraft", "peony");
    public static final VoxelMaterial TALL_GRASS = register("minecraft", "tall_grass");
    public static final VoxelMaterial LARGE_FERN = register("minecraft", "large_fern");
    public static final VoxelMaterial WHITE_BANNER = register("minecraft", "white_banner");
    public static final VoxelMaterial ORANGE_BANNER = register("minecraft", "orange_banner");
    public static final VoxelMaterial MAGENTA_BANNER = register("minecraft", "magenta_banner");
    public static final VoxelMaterial LIGHT_BLUE_BANNER = register("minecraft", "light_blue_banner");
    public static final VoxelMaterial YELLOW_BANNER = register("minecraft", "yellow_banner");
    public static final VoxelMaterial LIME_BANNER = register("minecraft", "lime_banner");
    public static final VoxelMaterial PINK_BANNER = register("minecraft", "pink_banner");
    public static final VoxelMaterial GRAY_BANNER = register("minecraft", "gray_banner");
    public static final VoxelMaterial LIGHT_GRAY_BANNER = register("minecraft", "light_gray_banner");
    public static final VoxelMaterial CYAN_BANNER = register("minecraft", "cyan_banner");
    public static final VoxelMaterial PURPLE_BANNER = register("minecraft", "purple_banner");
    public static final VoxelMaterial BLUE_BANNER = register("minecraft", "blue_banner");
    public static final VoxelMaterial BROWN_BANNER = register("minecraft", "brown_banner");
    public static final VoxelMaterial GREEN_BANNER = register("minecraft", "green_banner");
    public static final VoxelMaterial RED_BANNER = register("minecraft", "red_banner");
    public static final VoxelMaterial BLACK_BANNER = register("minecraft", "black_banner");
    public static final VoxelMaterial WHITE_WALL_BANNER = register("minecraft", "white_wall_banner");
    public static final VoxelMaterial ORANGE_WALL_BANNER = register("minecraft", "orange_wall_banner");
    public static final VoxelMaterial MAGENTA_WALL_BANNER = register("minecraft", "magenta_wall_banner");
    public static final VoxelMaterial LIGHT_BLUE_WALL_BANNER = register("minecraft", "light_blue_wall_banner");
    public static final VoxelMaterial YELLOW_WALL_BANNER = register("minecraft", "yellow_wall_banner");
    public static final VoxelMaterial LIME_WALL_BANNER = register("minecraft", "lime_wall_banner");
    public static final VoxelMaterial PINK_WALL_BANNER = register("minecraft", "pink_wall_banner");
    public static final VoxelMaterial GRAY_WALL_BANNER = register("minecraft", "gray_wall_banner");
    public static final VoxelMaterial LIGHT_GRAY_WALL_BANNER = register("minecraft", "light_gray_wall_banner");
    public static final VoxelMaterial CYAN_WALL_BANNER = register("minecraft", "cyan_wall_banner");
    public static final VoxelMaterial PURPLE_WALL_BANNER = register("minecraft", "purple_wall_banner");
    public static final VoxelMaterial BLUE_WALL_BANNER = register("minecraft", "blue_wall_banner");
    public static final VoxelMaterial BROWN_WALL_BANNER = register("minecraft", "brown_wall_banner");
    public static final VoxelMaterial GREEN_WALL_BANNER = register("minecraft", "green_wall_banner");
    public static final VoxelMaterial RED_WALL_BANNER = register("minecraft", "red_wall_banner");
    public static final VoxelMaterial BLACK_WALL_BANNER = register("minecraft", "black_wall_banner");
    ...
    public static final VoxelMaterial SPRUCE_DOOR = register("minecraft", "spruce_door");
    public static final VoxelMaterial BIRCH_DOOR = register("minecraft", "birch_door");
    public static final VoxelMaterial JUNGLE_DOOR = register("minecraft", "jungle_door");
    public static final VoxelMaterial ACACIA_DOOR = register("minecraft", "acacia_door");
    public static final VoxelMaterial DARK_OAK_DOOR = register("minecraft", "dark_oak_door");
    public static final VoxelMaterial END_ROD = register("minecraft", "end_rod");
    public static final VoxelMaterial CHORUS_PLANT = register("minecraft", "chorus_plant");
    public static final VoxelMaterial CHORUS_FLOWER = register("minecraft", "chorus_flower");
    ...
    public static final VoxelMaterial BEETROOTS = register("minecraft", "beetroots");
    ...
    public static final VoxelMaterial KELP = register("minecraft", "kelp");
    public static final VoxelMaterial KELP_PLANT = register("minecraft", "kelp_plant");
    public static final VoxelMaterial DRIED_KELP_BLOCK = register("minecraft", "dried_kelp_block");
    public static final VoxelMaterial TURTLE_EGG = register("minecraft", "turtle_egg");
    ...
    public static final VoxelMaterial DEAD_TUBE_CORAL = register("minecraft", "dead_tube_coral");
    public static final VoxelMaterial DEAD_BRAIN_CORAL = register("minecraft", "dead_brain_coral");
    public static final VoxelMaterial DEAD_BUBBLE_CORAL = register("minecraft", "dead_bubble_coral");
    public static final VoxelMaterial DEAD_FIRE_CORAL = register("minecraft", "dead_fire_coral");
    public static final VoxelMaterial DEAD_HORN_CORAL = register("minecraft", "dead_horn_coral");
    public static final VoxelMaterial TUBE_CORAL = register("minecraft", "tube_coral");
    public static final VoxelMaterial BRAIN_CORAL = register("minecraft", "brain_coral");
    public static final VoxelMaterial BUBBLE_CORAL = register("minecraft", "bubble_coral");
    public static final VoxelMaterial FIRE_CORAL = register("minecraft", "fire_coral");
    public static final VoxelMaterial HORN_CORAL = register("minecraft", "horn_coral");
    public static final VoxelMaterial DEAD_TUBE_CORAL_FAN = register("minecraft", "dead_tube_coral_fan");
    public static final VoxelMaterial DEAD_BRAIN_CORAL_FAN = register("minecraft", "dead_brain_coral_fan");
    public static final VoxelMaterial DEAD_BUBBLE_CORAL_FAN = register("minecraft", "dead_bubble_coral_fan");
    public static final VoxelMaterial DEAD_FIRE_CORAL_FAN = register("minecraft", "dead_fire_coral_fan");
    public static final VoxelMaterial DEAD_HORN_CORAL_FAN = register("minecraft", "dead_horn_coral_fan");
    public static final VoxelMaterial TUBE_CORAL_FAN = register("minecraft", "tube_coral_fan");
    public static final VoxelMaterial BRAIN_CORAL_FAN = register("minecraft", "brain_coral_fan");
    public static final VoxelMaterial BUBBLE_CORAL_FAN = register("minecraft", "bubble_coral_fan");
    public static final VoxelMaterial FIRE_CORAL_FAN = register("minecraft", "fire_coral_fan");
    public static final VoxelMaterial HORN_CORAL_FAN = register("minecraft", "horn_coral_fan");
    public static final VoxelMaterial DEAD_TUBE_CORAL_WALL_FAN = register("minecraft", "dead_tube_coral_wall_fan");
    public static final VoxelMaterial DEAD_BRAIN_CORAL_WALL_FAN = register("minecraft", "dead_brain_coral_wall_fan");
    public static final VoxelMaterial DEAD_BUBBLE_CORAL_WALL_FAN = register("minecraft", "dead_bubble_coral_wall_fan");
    public static final VoxelMaterial DEAD_FIRE_CORAL_WALL_FAN = register("minecraft", "dead_fire_coral_wall_fan");
    public static final VoxelMaterial DEAD_HORN_CORAL_WALL_FAN = register("minecraft", "dead_horn_coral_wall_fan");
    public static final VoxelMaterial TUBE_CORAL_WALL_FAN = register("minecraft", "tube_coral_wall_fan");
    public static final VoxelMaterial BRAIN_CORAL_WALL_FAN = register("minecraft", "brain_coral_wall_fan");
    public static final VoxelMaterial BUBBLE_CORAL_WALL_FAN = register("minecraft", "bubble_coral_wall_fan");
    public static final VoxelMaterial FIRE_CORAL_WALL_FAN = register("minecraft", "fire_coral_wall_fan");
    public static final VoxelMaterial HORN_CORAL_WALL_FAN = register("minecraft", "horn_coral_wall_fan");
    public static final VoxelMaterial SEA_PICKLE = register("minecraft", "sea_pickle");
    ...
    public static final VoxelMaterial BAMBOO_SAPLING = register("minecraft", "bamboo_sapling");
    public static final VoxelMaterial BAMBOO = register("minecraft", "bamboo");
    ...
    public static final VoxelMaterial SWEET_BERRY_BUSH = register("minecraft", "sweet_berry_bush");
    ...
    public static final VoxelMaterial WARPED_FUNGUS = register("minecraft", "warped_fungus");
    public static final VoxelMaterial WARPED_WART_BLOCK = register("minecraft", "warped_wart_block");
    public static final VoxelMaterial WARPED_ROOTS = register("minecraft", "warped_roots");
    public static final VoxelMaterial NETHER_SPROUTS = register("minecraft", "nether_sprouts");
    ...
    public static final VoxelMaterial CRIMSON_FUNGUS = register("minecraft", "crimson_fungus");
    public static final VoxelMaterial SHROOMLIGHT = register("minecraft", "shroomlight");
    public static final VoxelMaterial WEEPING_VINES = register("minecraft", "weeping_vines");
    public static final VoxelMaterial WEEPING_VINES_PLANT = register("minecraft", "weeping_vines_plant");
    public static final VoxelMaterial TWISTING_VINES = register("minecraft", "twisting_vines");
    public static final VoxelMaterial TWISTING_VINES_PLANT = register("minecraft", "twisting_vines_plant");
    public static final VoxelMaterial CRIMSON_ROOTS = register("minecraft", "crimson_roots");
    ...
    public static final VoxelMaterial CRIMSON_PRESSURE_PLATE = register("minecraft", "crimson_pressure_plate");
    public static final VoxelMaterial WARPED_PRESSURE_PLATE = register("minecraft", "warped_pressure_plate");
    ...
    public static final VoxelMaterial CRIMSON_BUTTON = register("minecraft", "crimson_button");
    public static final VoxelMaterial WARPED_BUTTON = register("minecraft", "warped_button");
    public static final VoxelMaterial CRIMSON_DOOR = register("minecraft", "crimson_door");
    public static final VoxelMaterial WARPED_DOOR = register("minecraft", "warped_door");
    public static final VoxelMaterial CRIMSON_SIGN = register("minecraft", "crimson_sign");
    public static final VoxelMaterial WARPED_SIGN = register("minecraft", "warped_sign");
    public static final VoxelMaterial CRIMSON_WALL_SIGN = register("minecraft", "crimson_wall_sign");
    public static final VoxelMaterial WARPED_WALL_SIGN = register("minecraft", "warped_wall_sign");
    ...
    public static final VoxelMaterial WHITE_CANDLE_CAKE = register("minecraft", "white_candle_cake", V1_17);
    public static final VoxelMaterial ORANGE_CANDLE_CAKE = register("minecraft", "orange_candle_cake", V1_17);
    public static final VoxelMaterial MAGENTA_CANDLE_CAKE = register("minecraft", "magenta_candle_cake", V1_17);
    public static final VoxelMaterial LIGHT_BLUE_CANDLE_CAKE = register("minecraft", "light_blue_candle_cake", V1_17);
    public static final VoxelMaterial YELLOW_CANDLE_CAKE = register("minecraft", "yellow_candle_cake", V1_17);
    public static final VoxelMaterial LIME_CANDLE_CAKE = register("minecraft", "lime_candle_cake", V1_17);
    public static final VoxelMaterial PINK_CANDLE_CAKE = register("minecraft", "pink_candle_cake", V1_17);
    public static final VoxelMaterial GRAY_CANDLE_CAKE = register("minecraft", "gray_candle_cake", V1_17);
    public static final VoxelMaterial LIGHT_GRAY_CANDLE_CAKE = register("minecraft", "light_gray_candle_cake", V1_17);
    public static final VoxelMaterial CYAN_CANDLE_CAKE = register("minecraft", "cyan_candle_cake", V1_17);
    public static final VoxelMaterial PURPLE_CANDLE_CAKE = register("minecraft", "purple_candle_cake", V1_17);
    public static final VoxelMaterial BLUE_CANDLE_CAKE = register("minecraft", "blue_candle_cake", V1_17);
    public static final VoxelMaterial BROWN_CANDLE_CAKE = register("minecraft", "brown_candle_cake", V1_17);
    public static final VoxelMaterial GREEN_CANDLE_CAKE = register("minecraft", "green_candle_cake", V1_17);
    public static final VoxelMaterial RED_CANDLE_CAKE = register("minecraft", "red_candle_cake", V1_17);
    public static final VoxelMaterial BLACK_CANDLE_CAKE = register("minecraft", "black_candle_cake", V1_17);
    ...
    public static final VoxelMaterial AMETHYST_CLUSTER = register("minecraft", "amethyst_cluster", V1_17);
    public static final VoxelMaterial LARGE_AMETHYST_BUD = register("minecraft", "large_amethyst_bud", V1_17);
    public static final VoxelMaterial MEDIUM_AMETHYST_BUD = register("minecraft", "medium_amethyst_bud", V1_17);
    public static final VoxelMaterial SMALL_AMETHYST_BUD = register("minecraft", "small_amethyst_bud", V1_17);
    ...
    public static final VoxelMaterial POINTED_DRIPSTONE = register("minecraft", "pointed_dripstone", V1_17);
    public static final VoxelMaterial DRIPSTONE_BLOCK = register("minecraft", "dripstone_block", V1_17);
    public static final VoxelMaterial CAVE_VINES = register("minecraft", "cave_vines", V1_17);
    public static final VoxelMaterial CAVE_VINES_PLANT = register("minecraft", "cave_vines_plant", V1_17);
    public static final VoxelMaterial SPORE_BLOSSOM = register("minecraft", "spore_blossom", V1_17);
    public static final VoxelMaterial AZALEA = register("minecraft", "azalea", V1_17);
    public static final VoxelMaterial FLOWERING_AZALEA = register("minecraft", "flowering_azalea", V1_17);
    public static final VoxelMaterial MOSS_CARPET = register("minecraft", "moss_carpet", V1_17);
    public static final VoxelMaterial MOSS_BLOCK = register("minecraft", "moss_block", V1_17);
    public static final VoxelMaterial BIG_DRIPLEAF = register("minecraft", "big_dripleaf", V1_17);
    public static final VoxelMaterial BIG_DRIPLEAF_STEM = register("minecraft", "big_dripleaf_stem", V1_17);
    public static final VoxelMaterial SMALL_DRIPLEAF = register("minecraft", "small_dripleaf", V1_17);
    public static final VoxelMaterial HANGING_ROOTS = register("minecraft", "hanging_roots", V1_17);
    ...
    public static final VoxelMaterial FROGSPAWN = register("minecraft", "frogspawn", V1_19);
    public static final VoxelMaterial MANGROVE_BUTTON = register("minecraft", "mangrove_button", V1_19);
    public static final VoxelMaterial MANGROVE_DOOR = register("minecraft", "mangrove_door", V1_19);
    ...
    public static final VoxelMaterial MANGROVE_PRESSURE_PLATE = register("minecraft", "mangrove_pressure_plate", V1_19);
    public static final VoxelMaterial MANGROVE_PROPAGULE = register("minecraft", "mangrove_propagule", V1_19);
    public static final VoxelMaterial MANGROVE_ROOTS = register("minecraft", "mangrove_roots", V1_19);
    public static final VoxelMaterial MANGROVE_SIGN = register("minecraft", "mangrove_sign", V1_19);
    ...
    public static final VoxelMaterial MANGROVE_WALL_SIGN = register("minecraft", "mangrove_wall_sign", V1_19);
    ...
    public static final VoxelMaterial SCULK_VEIN = register("minecraft", "sculk_vein", V1_19);
